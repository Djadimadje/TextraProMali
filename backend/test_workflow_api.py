...
def test_create_batch(access_token, user_id):
    ...
    batch_data = {
        ...
        "supervisor": user_id,  # Explicitly assign supervisor
...
def main():
    ...
    batch_id = test_create_batch(access_token, user_id)
...
def test_create_batch(access_token, user_id):
    ...
    batch_data = {
        "batch_code": "BATCH-001",
        "description": "Cotton textile batch for export",
        "supervisor": user_id,  # Assign current user as supervisor
        "start_date": str(date.today()),
        "end_date": str(date.today() + timedelta(days=30))
    }
...
def test_create_multiple_batches(access_token, user_id):
...
def main():
    ...
    additional_batch_ids = test_create_multiple_batches(access_token, user_id)
