...
import { qualityService, DashboardData, QualityCheck } from '../../../../../services/qualityService';
...
const QualityPage: React.FC = () => {
  ...
  useEffect(() => {
    console.log('Quality page useEffect triggered');
  ...
  const loadDashboardData = async () => {
    try {
      ...
      if (response.success) {
        ...
        console.error('Dashboard failed:', response.message);
            ...
            {activeTab !== 'dashboard' && (
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                <div className="text-center">
                  ...
                  <p className="text-gray-600">{activeTab} functionality will be implemented here.</p>
                </div>
              </div>
            )}
          </div>
